        ...
        <div className="flex flex-col gap-2 shrink-0 mb-2">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
            ...
            <input
              ...
              className="flex h-8 w-full sm:flex-1 rounded-md border border-input bg-transparent px-3 py-1 text-sm shadow-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
            />
